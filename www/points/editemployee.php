	...
	<?php
  			...
  			if(checkdate($smonth,$sday,$syear)){
  				if(checkdate($bmonth,$bday,$byear)){
					if($verify > 0){   
						...
						$update = "UPDATE pointemployees SET email='$email', start='$start', syear='$syear', birth='$birth', byear='$byear'
		...
		if(isset($_POST["delete"])){
			...
			if($verify > 0){   
				...
				$delete = "DELETE FROM pointemployees WHERE name='$name' AND id='$id' LIMIT 1";
