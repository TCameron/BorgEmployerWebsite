...
$check = mysql_query("SELECT * FROM rewardemployees WHERE start='$today'") or die(mysql_error());  
...
$check = mysql_query("SELECT * FROM rewardemployees WHERE birth='$today'") or die(mysql_error());  
$verify = mysql_num_rows($check); 
