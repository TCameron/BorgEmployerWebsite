...
{
	print "Error: the file specified by \$cgi_script_full does not exist ('$cgi_script_full').  You may need to edit your call_ub.php file and manually set the \$DOCROOT and/or \$cgi_script_full variables.";
	exit;
}
